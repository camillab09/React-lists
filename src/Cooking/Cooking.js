...
export const recipes = [
  ...
  },
  {
    ...
    buffs: "Buffs: Required for breeding.",
  ...
  },
  {
    ...
    buffs: "Buffs: Increases defence with 20%. ",
  ...
  },
  {
    ...
    buffs: "Buffs: Increases work speed with 30%.",
    cooker: "Available from Cooking Pot",
    image: ChikipiSaute,
  },
  {
    ...
    buffs: "Buffs: Increases work speed with 50%.",
    cooker: "Available from Electric Kitchen",
    image: DumudChowder,
  },
  {
    ...
    buffs: "Buffs: Increases attack with 20%.",
    cooker: "Available from Electric Kitchen",
  ...
  },
  {
    ...
    nutrition: 108,
    sanity: 14,
    ingredients: "1 Chikipi Poultry, 1 Flour, 1 Egg, 1 High Quality Pal Oil",
    buffs: "Buffs: Increases work speed with 30%, slows sanity decrease.",
    cooker: "Available from Electric Kitchen",
    image: FriedChikipi,
  },
  {
    ...
    sanity: 1,
    ingredients: "1 Egg",
    cooker: "Buffs: Available from Campfire",
    image: FriedEgg,
  },
  {
    dish: "Fried Kelpsea",
    nutrition: 108,
    sanity: 14,
    ingredients: "1 Raw Kelpsea, 1 Flour, 1 Egg, 1 High Quality Pal Oil",
    buffs: "Buffs: Increases defence with 10%, slows sanity decrease.",
    cooker: "Available from Electric Kitchen",
    image: FriedKelpsea,
  },
  {
  ...
  },
  {
    ...
    buffs: "Buffs: Increases defence with 10%.",
    cooker: "Available from Cooking Pot",
  ...
  },
  {
    ...
    buffs: "Buffs: Increases attack with 20%, slows hunger decrease. ",
    cooker: "Available from Electric Kitchen",
  ...
  },
  {
    ...
    buffs: "Buffs: Increases work speed with 50%, slows sanity decrease.",
    cooker: "Available from Electric Kitchen",
  ...
  },
  {
    ...
    buffs: "Buffs: Slows hunger decrease.",
    cooker: "Available from Cooking Pot",
    image: MushroomSoup,
  },
  {
    ...
    buffs: "Buffs: Increases attack with 10%.",
    cooker: "Available from Cooking Pot",
    image: Omelet,
  },
  {
    ...
    buffs: "Buffs: Slows sanity decrease.",
    cooker: "Available from Cooking Pot",
    image: Pancake,
  },
  {
    ...
    buffs: "Buffs: Increases work speed with 30%, slows hunger decrease.",
    cooker: "Available from Electric Kitchen",
    image: Pizza,
  },
  {
